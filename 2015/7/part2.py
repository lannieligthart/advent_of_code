...
# give b the signal that was the output for part 1
circuit['b'] = Wire(name='b', value=16076)
...
for instr in data:
    ...
    instr = instr.split(" -> ")
    name = instr[1]
    # skip b because it gets a custom value
    if name == 'b':
        pass
    # if equation contains a NOT operator, extract n1 and the operator
    elif instr[0].startswith("NOT"):
