from AoC_tools.aoc22 import read_input, Point, Grid, start, end

# works only for example, for real data mappings need to be adjusted
...
data = read_input("testinput2.txt", "\n\n", strip=False)
instructions = data[6]
...
cube.side.grid.add(cube.position, "@")
for s in sides.values():
    s.grid.display()

final_col = cube.position[0] + 4 + 1
final_row = cube.position[1] + 4 + 1
